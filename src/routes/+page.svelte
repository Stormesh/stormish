...
<svelte:head>
	<title>Stormish | Home</title>
	<meta name="description" content="Andrew's personal website" />
</svelte:head>

<Landing />
<SectionF header="About Me">
	<p class="text-justify">
		Hello, My name is <b>Andrew</b>, I'm a software developer who loves to build tools and create applications to make life easier for myself and others. I'm passionate about learning and growing as a developer, and I believe that knowledge is the key to unlocking my full potential.
	</p>
</SectionF>
